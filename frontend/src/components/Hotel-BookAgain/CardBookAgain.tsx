...
function CardBookAgain({ cage_type, size, width, height, lenth, price, facility, max_capacity, startDate, endDate, onCheckInClick }: CageCardType) {
        ...
        <div>
            ...
            <div className="flex h-60 m-5 p-3 rounded-md shadow shadow-gray-400">
                ...
                <div className="basis-1/3  space-y-5 pl-5 pt-4 flex flex-col items-end pr-5">
                    <CounterButton />
                    <div>
                        <p className="hover:text-teal-500 hover:underline" onClick={onCheckInClick}>
