...
function CreateProfile() {
  ...
  const handleSignup = async () => {
    ...
    try {
      const response = await fetch(`${BASE_API}/profile/create`, {
        method: "POST",
        headers: {
        ...
        <div className="flex flex-col items-center w-1/4 gap-y-5 pt-24">
          ...
          <div className="flex w-full  gap-x-3">
            ...
            <div className="flex flex-col gap-y-2 w-full pl-5">
              ...
              <div
                className="h-12 w-full mb-5 rounded-lg bg-onstep hover:bg-nextstep cursor-pointer text-white flex justify-center items-center"
                onClick={handleClickFullMap}
              >
                Select Position
              </div>
            </div>
