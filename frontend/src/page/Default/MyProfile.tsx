...
export default function MyProfile() {
  ...
  const handleSelectPet = (id: string) => {
    if (id != "") {
      setIsAdding(false);
      const selectedPetInfo = allPet.find(
        (pet: any) => pet.id === parseInt(id)
      );
      console.log(id);
      if (selectedPetInfo) {
        ...
        return (
          <div>
            <div className=" mt-5 pr-10 flex justify-end ">
              <div
                className="rounded-full bg-bg shadow shadow-gray-400 w-20 h-7 items-center flex justify-center gap-x-2 text-gray-500 cursor-pointer"
        ...
        return (
          <div>
            <div className="flex flex-row">
              ...
              <button
                onClick={() => handleSetAddingPetData()}
                className="ml-5 shadow-xl text-black px-4 py-2 rounded-md hover:bg-[#be914c]"
              >
                Add Pet
              </button>
            </div>
            ...
            {pet ? (
                    ...
                    {isEditing ? (
                      ...
                      petImage ? (
                        ...
                        <div className="relative w-full top-16  h-full rounded-full flex justify-center items-center cursor-pointer">
                          <UploadImage
                            limit={1}
                            onComplete={handlePetImageUpload}
                          />
                        </div>
                      )
                    ) : (
                    ...
                    <div className="flex gap-x-5 flex-col space-x-48  w-full h-full">
                      <div className="flex justify-between w-full">
                        ...
                        <div className="flex justify-end">
                          <div
                            className="rounded-full bg-bg shadow shadow-gray-400 w-20 h-7 items-center flex justify-center gap-x-2 text-gray-500 cursor-pointer m-2"
                            onClick={
                              isEditing ? savePetProfile : toggleEditMode
                            }
                          >
                            <p>{isEditing ? "Save" : "Edit"}</p>
                            <i className="fa-regular fa-pen-to-square"></i>
              ...
              <div className="mt-5 ont-medium">Select Pet First</div>
            )}
          </div>
