...
function HotelResponseAccept() {
  ...
  useEffect(() => {
    ...
    fetch(`${BASE_API}/hotel/${id}/accepted`, {
      method: "GET",
      headers: {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <div className="flex-grow">
        ...
        <h2 className="max-w-screen-xl mx-auto text-2xl  mt-10">Accepted</h2>
        <div className="pb-10">
          {Array.isArray(hotels) && hotels.length > 0 ? (
            <div>
              {hotels
                .filter((hotel) => hotel.status === "accepted")
                  ...
                  >
                    ...
                    <div className="col-span-3 ml-5 mt-5 space-y-4">
                      ...
                      <div className="flex justify-end mt-auto mb-0 space-x-4 pt-2">
                        <button className="bg-button px-10 py-2 border rounded-2xl shadow-lg shadow-egg">
                          Contract
                        </button>
                      </div>
                    </div>
            ...
            <div className="text-center py-4">
              No accepted hotel reservation information found.
            </div>
          )}
        </div>
      </div>
