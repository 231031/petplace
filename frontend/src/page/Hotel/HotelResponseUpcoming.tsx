...
function HotelResponseUpcoming() {
  ...
  useEffect(() => {
    ...
    fetch(`${BASE_API}/hotel/${id}/pending`, {
      method: "GET",
      headers: {
        ...
        <div className="pb-10">
          {Array.isArray(hotels) && hotels.length > 0 ? (
                  ...
                  >
                    ...
                    <div className="col-span-3 ml-5 mt-5 space-y-4">
                      ...
                      <div className="flex justify-end mt-auto mb-0 space-x-4 pt-2">
                        <button
                          onClick={() =>
                            handleAcceptReject(hotel.id, "rejected")
                          }
                        ...
                        <button
                          onClick={() =>
                            handleAcceptReject(hotel.id, "accepted")
                          }
            ...
            <div className="text-center py-4">
              No upcoming hotel reservation information found.
            </div>
          )}
        </div>
      </div>
